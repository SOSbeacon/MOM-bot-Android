...
public class BleActionsReceiver extends BroadcastReceiver {
	 ...
	 * ACTION_GATT_DISCONNECTED: disconnected from a GATT server. ACTION_GATT_SERVICES_DISCOVERED: discovered GATT
	 * services. ACTION_DATA_AVAILABLE: received data from the device. This can be a result of read or notification
	 * operations.
	 * 
	 * @param context
	 * @param intent
