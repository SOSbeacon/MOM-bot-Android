...
import org.cnc.msrobot.task.calendar.AsyncBatchInsertCalendars;
import org.cnc.msrobot.task.calendar.AsyncDeleteCalendar;
import org.cnc.msrobot.task.calendar.AsyncInsertCalendar;
import org.cnc.msrobot.task.calendar.AsyncLoadCalendars;
import org.cnc.msrobot.task.calendar.AsyncUpdateCalendar;
import org.cnc.msrobot.task.calendar.CalendarInfo;
import org.cnc.msrobot.task.calendar.CalendarModel;
...
/**
 * Sample activity for Google Calendar API v3. It demonstrates how to use authorization to list calendars, add a new
 * calendar, and edit or delete an existing calendar with the user's permission.
 * 
 * <p>
 * <b>Warning:</b> this sample is for illustrative purposes only. Please instead use the native Calendar APIs like the
 * <a href="http://developer.android.com/guide/topics/providers/calendar-provider.html">Calendar Provider API</a>.
 * </p>
 * 
 * @author Yaniv Inbar
 */
...
//						CalendarSampleActivity.this, REQUEST_GOOGLE_PLAY_SERVICES);
//				dialog.show();
//			}
//		});
//	}
...
//					return true;
//				case CONTEXT_DELETE:
//					new AlertDialog.Builder(this).setTitle(R.string.delete_title).setMessage(calendarInfo.summary)
//							.setCancelable(false)
