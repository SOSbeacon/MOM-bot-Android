...
public class RecognizeSmsTo extends RecognizeBase implements RecognizeModuleListener {
	private MainActivity activity;

	public RecognizeSmsTo(MainActivity activity) {
		super(activity, RecoginizeIds.MODULE_SMS_TO, activity.getString(R.string.recognize_sms_to), activity
				.getString(R.string.recognize_sms_to), null, false);
	...
	public void onRecoginze(final ArrayList<String> data) {
		...
		if (found) {
			activity.doRecognizeModule(RecoginizeIds.MODULE_SMS_BODY);
