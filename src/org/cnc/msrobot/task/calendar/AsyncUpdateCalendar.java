...
public class AsyncUpdateCalendar extends CalendarAsyncTask {
	...
	public AsyncUpdateCalendar(CalendarEventActivity calendarSample, String calendarId, Calendar entry) {
	...
	protected void doInBackground() throws IOException {
		try {
			Calendar updatedCalendar = client.calendars().patch(calendarId, entry).setFields(CalendarInfo.FIELDS)
					.execute();
